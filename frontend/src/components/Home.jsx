      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full flex flex-col md:flex-row items-center justify-between relative z-10 pt-32 pb-20">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 mb-10">
            <a href="https://www.facebook.com/ichanchalssoni" className="bg-blue-800 text-white p-3 rounded-full text-xl shadow-lg hover:scale-110 transition-all flex items-center justify-center w-12 h-12"><FaFacebookF /></a>
            <a href="https://www.instagram.com/ichanchalssoni" className="bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-500 text-white p-3 rounded-full text-xl shadow-lg hover:scale-110 transition-all flex items-center justify-center w-12 h-12"><FaInstagram /></a>
